...
type mysqlConfig struct {
	...
	MysqlDBName string `env:"MYSQL_DB_NAME" default:"grape-dev"` // 目标数据库
	MysqlUser   string `env:"MYSQL_USER" default:"root"`
	MysqlPwd    string `env:"MYSQL_PWD" default:"1234qwer"` // 1234qwer
	// other
	MysqlDBNameBoxWX  string `env:"MYSQL_DB_NAME_BOX_WX" default:"grape-dev"`  // 微信数据源
	MysqlDBNameBoxAct string `env:"MYSQL_DB_NAME_BOX_ACT" default:"grape-dev"` // 激活码数据源
	MysqlDBNameBoxAPI string `env:"MYSQL_DB_NAME_BOX_ACT" default:"grape-dev"` // 课程数据源
	//
}
