...
function SelectDateB(objname,strFormat)
{
	var obj = document.getElementById(objname);
	SelectDate(obj,strFormat);
}
...
//document.write('<div id="ContainerPanel" style="display:none;">A<div id="calendarPanel" style="position: absolute;display: none;z-index: 9999;');
document.write('<div id="ContainerPanel" style="display:none;"><div id="calendarPanel" style="position: absolute;display: none;z-index: 9999;');
document.write('background-color: #FFFFFF;border: 1px solid #CCCCCC;width:175px;font-size:12px;"></div>');
if(document.all)
{
//document.write('<iframe style="position:absolute;z-index:2000;width:expression(this.previousSibling.offsetWidth);'); //old
//document.write('<iframe style="position:absolute;z-index:-2000;background-color:transparent;width:expression(this.previousSibling.offsetWidth);'); //jl
