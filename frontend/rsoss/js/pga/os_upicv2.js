...
function DialogOpen(o){
	if(o==1) $("#pg_piclist").show();
	else $("#pg_piclist").hide();
}
...
$(document).ready(function(){
	...
	function bindLi_event(){
		...
		$("#dvPlist").children("li").each(function(){
				$(this).click(function(){
					...
					var urlsrc= $(this).children("dd").children("img").attr("src");
					var urlv= $(this).children("dd").children("img").attr("alt");
	...
	function Event_Bt(){
		var imgValue= $("#DImgValue").val()  ;
		var purl= $("#DImgUrl").val()  ;
		var txt ="【"+ $("#dvSelName").text()  + "】" ;
		//alert("V="+purl+",T="+ txt );
