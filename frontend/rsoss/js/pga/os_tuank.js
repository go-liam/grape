var osTuank  = function()
{
  ...
  this.list_yuiLAct_Bt=function(){
		...
		ajaxobj.method = "POST";   //
		ajaxobj.url = "../../ca/ufw/kyk_list.aspx" ; //
   ...
   //-----------------------------------
      ...
      //-----------------------------------
     this.list_UqianDaoAct_Bt=function(){
		//alert('111')
		if(this.slistAct_Ckeck()==false) return ;
		if(regVars.isDoing) return ;
			regVars.isDoing = true ;
		var ajaxobj = new ck.AJAXRequest;    // 
		ajaxobj.method = "POST";   //
		ajaxobj.url = "../../ca/ufw/us/t2_us_qiandaolist.aspx" ; //
		ajaxobj.content =purl;//
		ajaxobj.callback = function(xmlobj) {
			//ck.Log("dvLog", xmlobj.responseText );
			jtk.Json_CallBack2(xmlobj.responseText,"dvInfo");
     ...
     this.list_UserAct_Bt=function(){
		...
		var ajaxobj = new ck.AJAXRequest;    // 
		ajaxobj.method = "POST";   //
		ajaxobj.url = "../../ca/ufw/us/t2_user_list.aspx" ; //
		ajaxobj.content =purl;//
		ajaxobj.callback = function(xmlobj) {
			//ck.Log("dvLog", xmlobj.responseText );
			jtk.Json_CallBack2(xmlobj.responseText,"dvInfo");
 ...
 //-----------------------------------
     this.list_ShopAct_Bt=function(){
		...
		var ajaxobj = new ck.AJAXRequest;    // 
		ajaxobj.method = "POST";   //
		ajaxobj.url = "../../ca/ufw/sh/t2_shop_list.aspx" ; //
		ajaxobj.content =purl;//
		ajaxobj.callback = function(xmlobj) {
			//ck.Log("dvLog", xmlobj.responseText );
			jtk.Json_CallBack2(xmlobj.responseText,"dvInfo");
   ...
   //-----------------------------------
      ...
      //-----------------------------------
       this.list_CityClassAct_Bt=function(){
		if(this.slistAct_Ckeck()==false) return ;
		if(regVars.isDoing) return ;
			regVars.isDoing = true ;
		var ajaxobj = new ck.AJAXRequest;    // 
		ajaxobj.method = "POST";   //
		ajaxobj.url = "../../ca/ufw/sh/t2_city_list.aspx" ; //
		ajaxobj.content =purl;//
		ajaxobj.callback = function(xmlobj) {
			//ck.Log("dvLog", xmlobj.responseText );
			jtk.Json_CallBack2(xmlobj.responseText,"dvInfo");
