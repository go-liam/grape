...
function dTree(objName,pathImgCss,inputType,pathImgCssDir) {
	...
	if(pathImgCss==null || pathImgCss.length<1)
		pathImgCss="rs/images/menu/1/skins/default";
...
{  
	...
	if(obj.type=='radio')
		return;
	//閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹鍜忚瘶閿熼叺闈╂嫹閿熻妭纰夋嫹
...
{	//鍚岄敓鏂ゆ嫹璇橀敓锟�
   ...
   if(obj.nodeId==0)return ; 
	...
	//check
	if(status) //璇撮敓鏂ゆ嫹閿熸枻鎷疯瘶閿熸彮顎扳槄鎷烽敓锟�
	{  		
			//disable
			if(statusDisabled)
			{
	...
	{ 
		//false 璇撮敓鏂ゆ嫹鍚岄敓鑺傜偣鍙婇敓鏂ゆ嫹閿熸帴鑺傜鎷烽敓鐭紮鎷烽敓楗侯偓鎷烽敓鏂ゆ嫹閿熺獤鈽呮嫹閿燂拷
		  pobj.disabled = false;
		  pobj.checked = false;
		  setParent(pobj); 
	}
	 ...
	 /*
	 *
	 *鍏ㄩ敓鏂ゆ嫹閿熸埅纭锋嫹閿熸枻鎷烽敓鏂ゆ嫹閿熸枻鎷烽敓鏂ゆ嫹
	 */ 	 
	function disableAll()
	{
