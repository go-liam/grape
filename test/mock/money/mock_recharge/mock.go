...
// Source: ./internal/pkg/data/money/recharge/interface.go
...
import (
	...
	recharge "grape/internal/pkg/data/money/recharge"
	reflect "reflect"
)
...
func (m *MockService) Create(item *recharge.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindOne(id int64) (*recharge.Model, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOne", id)
	ret0, _ := ret[0].(*recharge.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) FindMulti(page *response.Pagination, s *response.ListParameter) ([]*recharge.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(item *recharge.Model) (int64, error) {
	m.ctrl.T.Helper()
