...
// Source: ./internal/pkg/data/money/change/interface.go
...
import (
	...
	change "grape/internal/pkg/data/money/change"
	reflect "reflect"
)
...
func (m *MockService) Create(item *change.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindOne(id int64) (*change.Model, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOne", id)
	ret0, _ := ret[0].(*change.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) FindMulti(page *response.Pagination, s *response.ListParameter) ([]*change.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(item *change.Model) (int64, error) {
	m.ctrl.T.Helper()
