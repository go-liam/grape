...
// Source: ./internal/pkg/data/home_site/page/interface.go
...
import (
	...
	page "grape/internal/pkg/data/home_site/page"
	reflect "reflect"
)
...
func (m *MockService) Create(item *page.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindOne(id int64) (*page.Model, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOne", id)
	ret0, _ := ret[0].(*page.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) FindMulti(page *response.Pagination, s *response.ListParameter) ([]*page.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(item *page.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) CacheOne(id int64) (*page.Model, error) {
	m.ctrl.T.Helper()
