...
// Source: ./internal/pkg/data/home_site/notice/interface.go
...
import (
	...
	notice "grape/internal/pkg/data/home_site/notice"
	reflect "reflect"
)
...
func (m *MockService) Create(item *notice.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindOne(id int64) (*notice.Model, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOne", id)
	ret0, _ := ret[0].(*notice.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) FindMulti(page *response.Pagination, s *response.ListParameter) ([]*notice.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(item *notice.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) CacheOne(id int64) (*notice.Model, error) {
	m.ctrl.T.Helper()
