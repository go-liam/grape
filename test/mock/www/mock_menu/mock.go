...
// Source: ./internal/pkg/data/home_site/menu/interface.go
...
import (
	...
	menu "grape/internal/pkg/data/home_site/menu"
	reflect "reflect"
)
...
func (m *MockService) Create(item *menu.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindOne(id int64) (*menu.Model, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOne", id)
	ret0, _ := ret[0].(*menu.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) FindMulti(page *response.Pagination, s *response.ListParameter) ([]*menu.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(item *menu.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) CacheMulti() ([]*menu.Model, error) {
	m.ctrl.T.Helper()
