...
// Source: ./internal/pkg/data/config/interface.go
...
import (
	...
	config "grape/internal/pkg/data/config"
	reflect "reflect"
)
...
func (m *MockService) Create(item *config.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindOne(id int64) (*config.Model, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindOne", id)
	ret0, _ := ret[0].(*config.Model)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockService) FindMulti(page *response.Pagination, s *response.ListParameter) ([]*config.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(item *config.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) CacheOne(id int64) (*config.Model, error) {
	m.ctrl.T.Helper()
