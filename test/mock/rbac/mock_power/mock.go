...
// Source: ./internal/pkg/data/rbac/power/interface.go

// Package mock_power is a generated GoMock package.
package mock_power

import (
	response "github.com/go-liam/util/response"
	gomock "github.com/golang/mock/gomock"
	power "grape/internal/pkg/data/rbac/power"
	reflect "reflect"
)
...
func (m *MockService) Create(item *power.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) FindOne(id int64) (*power.Model, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) Update(item *power.Model) (int64, error) {
	m.ctrl.T.Helper()
...
func (m *MockService) CacheOne(id int64) (*power.Model, error) {
	m.ctrl.T.Helper()
